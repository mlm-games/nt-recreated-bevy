...
pub fn enemy_def(kind: EnemyKind) -> EnemyDef {
    match kind {
        ...
        EnemyKind::IceFlower => EnemyDef {
            ...
            projectile_radius: 4.0,
            projectile_lifetime: 3.2,
            projectile_color: Color::srgb(0.6, 0.9, 1.0),
            projectile_size: 7.0,
            boss: false,
        },
        EnemyKind::SuperFrog => EnemyDef {
            ...
            projectile_radius: 4.0,
            projectile_lifetime: 2.5,
            projectile_color: Color::srgb(0.4, 1.0, 0.4),
            projectile_size: 6.0,
            boss: false,
        },
        ...
        EnemyKind::HostileHorror => EnemyDef {
            ...
            projectile_radius: 5.0,
            projectile_lifetime: 3.0,
            projectile_color: Color::srgb(0.7, 0.3, 1.0),
            projectile_size: 8.0,
            boss: false,
        },
...
mod idpd_def_tests {
    ...
    fn idpd_shield_is_midrange() {
        ...
        assert_eq!(def.shoot_range, 250.0);
    }
}
